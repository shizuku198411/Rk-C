...
def filesystem_tests() -> list[TestCase]:
    ...
    return [
        ...
        TestCase("resolver finds administrator executable", "which dev_echo", ["/usr/bin/dev_echo"]),
        TestCase("root executes /usr/bin binary", "/usr/bin/dev_echo phase0-root", ["phase0-root"]),
        TestCase("root executes searched /usr/bin binary", "dev_echo phase1-root", ["phase1-root"]),
