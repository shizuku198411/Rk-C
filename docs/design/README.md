...
This directory contains subsystem-level design notes for Rk-C.

The top-level project README is intentionally short and focuses on project
overview, build steps, run steps, and test commands. Details about kernel,
userland, and service behavior live here.
